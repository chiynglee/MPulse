...
set opt(ragent)		Agent/rtProto/MPULSE
set opt(pos)		NONE

if { $opt(pos) != "NONE" } {
	puts "*** WARNING: MPULSE using $opt(pos) position configuration..."
}
...
Agent/rtProto/MPULSE instproc init args {
        $self next $args
}       

Agent/rtProto/MPULSE set sport_	0
Agent/rtProto/MPULSE set dport_	0
