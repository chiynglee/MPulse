...
set opt(ragent)		Agent/rtProto/PULSE
set opt(pos)		NONE

if { $opt(pos) != "NONE" } {
	puts "*** WARNING: PULSE using $opt(pos) position configuration..."
}
...
Agent/rtProto/PULSE instproc init args {
        $self next $args
}       

Agent/rtProto/PULSE set sport_	0
Agent/rtProto/PULSE set dport_	0
